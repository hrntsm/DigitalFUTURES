...
最適化は Grasshopper 内での既存のツールを使ったものだけでなく、RhinoCompute と Python を使った最適化についても紹介します。

## 連絡事項

最終日は各個人での作業時間になります。
13 時からスタートですが、特に私からのレクチャーはありません。
Zoom 自体は起動していますので、参加してください。
製作にあたって質問事項がある方はこの時に質問してください。

15 時から各参加者の成果物の発表時間です。
本 WS は特にかっこいい形やきれいなパースの作り方などのレクチャーは行っていないので、例えばこういったものをコーディングしてみて出た形のようなコードメインの話でも構いません。
皆さんの作成されたものを見ることを楽しみにしています。

なお、昨日運営から連絡があったのですが、本 WS の成果品は DigitalFUTURES メタバースというものが作成されそこに展示されます。
最終日の発表時間で見せていただいたものを適宜私の方で切り抜いて運営に成果品として報告するのでその点ご理解よろしくお願いいたします。
もちろんデータを送付していただいても構いません。
