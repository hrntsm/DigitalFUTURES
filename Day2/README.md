...
自分の自己紹介を忘れていたので、自己紹介します。

Karamba3d の環境が皆さんで合わずにうまくいかなかった人もいるので、私が使っているKaramba.iniファイルを共有します。
必要な方は data に入っているのでダウンロードして適用してください。
Karamba.ini について簡単な説明をする。

復習していて質問点などが出た方がいたら質問してください。
