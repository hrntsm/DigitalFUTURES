...
別の方法で実現する手段が DataTree や List を使った操作だと考えてください。

一例として、DataTree を使った文字列の結合について紹介します。
これは以下の動画の一部から取ってきています。
英語ですがわかりやすいので、1度は必ず見ることをおススメします。

- [The deal with Data Trees](https://www.youtube.com/watch?v=ob3ER12ut3Y)

![data_tree](./image/data_tree.jpg)
